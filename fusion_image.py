...
if gray:
    ...
    result_path = './tttttttttttttt/Tno_fusion_result/'

    # IR_image_path = 'test_data/Road/1/'
    # VIS_image_path = 'test_data/Road/2/'
    # result_path = './tttttttttttttt/Road_fusion_result/'

    weight_path = './weight_attention/0409_15-46_Gray_epoch=3.pt'
else:
    # IR_image_path = 'test_data/Lytro/1/'
    # VIS_image_path = 'test_data/Lytro/2/'
    # result_path = './tttttttttttttt/Lytro_fusion_result/'

    IR_image_path = 'test_data/Exposure/1/'
    VIS_image_path = 'test_data/Exposure/2/'
    result_path = './tttttttttttttt/Exposure_fusion_result/'

    weight_path = './weight/0409_13-28_RGB_epoch=2.pt'
